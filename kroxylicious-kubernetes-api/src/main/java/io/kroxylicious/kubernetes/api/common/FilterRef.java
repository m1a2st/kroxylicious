...
/**
 * A reference, used in a Kubernetes resource, to a {@link KafkaProtocolFilter} resource in the same namespace.
 *
 * <p>This is a statically-typed ref: {@code group} ({@code "kroxylicious.io"}) and
 * {@code kind} ({@code "KafkaProtocolFilter"}) are hardcoded constants and are not serialized
 * to JSON.  Only {@code name} appears in the CRD schema.</p>
 *
 * <p>Despite being a distinct Java class, a {@code FilterRef} is considered equal to any
